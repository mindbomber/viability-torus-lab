  ...
  return (
    <div className="dashboard-view">
      <section className="scenario-title-row">
        ...
        <div className="scenario-facts"><span><small>Optimizes</small>{scenario.optimizedOutcome}</span><span><small>Current seed</small>{params.seed}</span><span><small>Watchlist / live status</small>{scenario.watchlistTier.toUpperCase()} / {frame.status}</span></div>
      </section>
