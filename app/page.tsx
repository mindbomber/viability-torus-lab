...
import { CONTRACT_VERSION } from "@/contracts/constants";
    ...
    <div className={`app-shell ${highContrast ? "high-contrast" : ""}`}>
      ...
      <div className="app-main">
        ...
        <main id="main-content" tabIndex={-1}>
          ...
          {view === "compare" && <CompareMode scenario={scenario} params={params} primaryFrames={run.frames} primarySummary={run.summary} />}
